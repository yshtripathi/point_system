  ...
  <div class="container position-relative pb-0">
    ...
    <div class="row m-0 mt-5">
      <div class="col-md-3 col-xl-3 mb-5">
        <div class="nav flex-column  nav-vertical product__categories border shadow bg-white" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <div class="col-md-9 col-xl-9 mb-5">
        <!-- Nav Tabs Content -->
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            ...
                                            <div class="contact-three__btn-box d-flex">
                                                <button type="submit" class="theme-btn btn-style-one me-auto"><span> Continue </span></button>
                                                          <button type="submit" class="theme-btn btn-style-one"> <span> Back </span> </button>
            ...
            <div id="collapseTwo" class="accordion-collapse collapse d-md-block" aria-labelledby="headingTwo" data-bs-parent="#myTabContent">
               <div class="accordion-body">
                ...
                <div class="text-center">
                  <p class="subtitle">{{ __('common.change_password') }}</p>
...
@endif
               <form method="POST" action="{{route('change.password')}}" id="passwordform">
                 @csrf
                  ...
                  <a class="theme-btn btn-style-one me-auto" href="{{route('user')}}"> <span> Back </span> </a>
             ...
             <div class="accordion-body">
              ...
              <th>{{ __('common.action') }}</th>
                    ...
                    <td>{{$order->first_name}} {{$order->last_name}}</td>
                      ...
                      <a href="{{route('user.order.show',$order->id)}}"  data-toggle="tooltip" title="view" data-placement="bottom" class="theme-btn btn-style-two"><span class="icon-angles-right"></span> View</a>
      ...
      <a href="{{route('user')}}" class="btn btn-primary"> <span> Back </span> </a>
            ...
            <div id="collapsesix" class="accordion-collapse collapse d-md-block" aria-labelledby="headingsix" data-bs-parent="#myTabContent">
              <div class="accordion-body ">
                ...
                <div class="order-list">
                  ...
                  <div class="contact-three__btn-box d-flex mt-3">
                                                <button type="submit" class="theme-btn btn-style-one me-auto"><span> Continue </span></button>
                                                          <button type="submit" class="theme-btn btn-style-one ms-auto"> <span> Back </span> </button>
