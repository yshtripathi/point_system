...
<section class="accunt-info position-relative">         
  <div class="container pt-0 position-relative pb-0">
...
@endif
  ...
  {{number_format($order->total_amount, $order->currency=='JPY' ? 0 : 2)}}                            
                      ...
                      <a href="{{route('user.order.show',$order->id)}}"  data-toggle="tooltip" title="view" data-placement="bottom" class="theme-btn btn-style-one"><span class="icon-angles-right"></span> {{ __('common.view_details') }}</a>
