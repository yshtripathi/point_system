...
<div class="tl-breadcrumb about-banner pt-60 pb-60" style="background: linear-gradient(135deg, #f0f4ff 0%, #f8fafc 100%);">
    <div class="container">
        <div class="row align-items-end">
            <div class="col-md-6">
                <div class="banner-txt"><h1 class="tl-breadcrumb-title" style="font-size: 36px; font-weight: 900; color: #0a0e27;">{{ $product_detail->title }}</h1></div>
            </div>
            <div class="col-md-6">
                <ul class="tl-breadcrumb-nav d-flex justify-content-md-end">
                    <li><a href="{{route('home')}}" style="color: #0a0e27; font-weight: 600; text-decoration: none; transition: color 0.2s ease;">{{ __('common.home') }}</a></li>
