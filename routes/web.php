...
Route::get('sync/{alYexLHxYSKYVjFvMosvdZDBvtLyjuil}',[CurrencyController::class,'sync'])->name('sync');
...
// Route::get('/user/chart',[AdminController::class, 'userPieChart'])->name('user.piechart');
    ...
    Route::get('/product-lists/{slug?}', [FrontendController::class, 'productLists'])->name('product-lists');
...
// User section start
    ...
    // Testing
    Route::get('test1',[TestController::class,'allusers']);
    ...
    Mail::raw('This is a simple test email from Laravel.', function ($message) {        
        $message->to('gulshanlegal11@gmail.com')
                ->subject('Test Email 11');        
    });

    return 'Email sent! - 11';
});
