...
yield _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/var/www/html/web7/public/dbadmin/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
